...
function PusherChatWidget(pusher, options) {
  ...
  this.settings = $.extend({
    ...
    channelName: 'insta-global',//document.location.href, // the name of the channel the chat will take place on
...
PusherChatWidget._buildListItem = function(activity) {
  ...
  var image = $('<div class="image">' +
                  '<img class="img-circle" src="' + imageInfo.url + '" width="' + imageInfo.width + '" height="' + imageInfo.height + '" />' +
                '</div>');
  item.append(image);
